...
<html lang="en-us">
    ...
    <body>
        <div class = "container">
            ...
            <p>Currently the email feild will accept any correctly fomated email address when creating a new account. 
            It does not require a real email addess. Ideally,
            it would be nice to have it accept only real email addresses so that when a user forgets his or her password, he or she can
            ...
            <?php
                ...
                {
                    echo    '<div class = "list">
                                <br><a class = "smalllink" href = "./login.php">Login To Existing Account</a>
			                    <a style = "margin-left: 14px;" class = "smalllink" href = "./create-account.php">Create New Account</a><br>
			                </div>';
                }
            ?>
        </div>
