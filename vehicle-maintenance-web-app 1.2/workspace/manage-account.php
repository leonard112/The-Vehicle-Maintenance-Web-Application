    ...
    <body>
        <div class = "container">
            ...
            <div class = "row list" style = "margin-top: 160px">
                <div class = "col-md-6 centerdata"><a class = "link" href = "./change-password.php">Change Password</a></div>
                <div class = "col-md-6 centerdata"><a class = "link" href = "./delete-account-confirm.php">Delete Account</a></div>
            </div>
        </div>
        <?php
            include("./footer.php");
